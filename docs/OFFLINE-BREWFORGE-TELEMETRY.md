...
The adapter itself is an additive experimental Python API. Its CLI consumer is documented separately;
the adapter adds no persisted schema, configuration format, credential boundary, network integration,
