...
> [!IMPORTANT]
> This is the pre-1.0 compatibility design for Forge Companion. Version 0.2.1 does not implement the
> JSON option. The current unreleased code implements `doctor --json`.
